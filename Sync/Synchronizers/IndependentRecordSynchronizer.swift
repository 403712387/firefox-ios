...
extension TimestampedSingleCollectionSynchronizer {
     ...
     */
    func uploadRecords<T>(records: [Record<T>], by: Count, lastTimestamp: Timestamp, storageClient: Sync15CollectionClient<T>, onUpload: POSTResult -> DeferredTimestamp) -> DeferredTimestamp {
        if records.isEmpty {
